    ...
    <div class="container mx-auto">
      ...
      <div class="relative w-full overflow-hidden">
        ...
        >
          ...
          >
            <img :src="event.banner ? `/storage/${event.banner}` : 'https://images.unsplash.com/photo-1522158637959-30385a09e0da?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'" :alt="event.title" class="w-full h-[160px] object-cover">
            <div class="p-4">
